...
class _$_TeacherInfoResponse implements _TeacherInfoResponse {
  ...
  @override
  String toString() {
    return 'TeacherInfoResponse(id: $id, teacherName: $teacherName, image: $image, employeeCode: $employeeCode, employeePosition: $employeePosition, branch: $branch, positionId: $positionId, telephone: $telephone, email: $email)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, teacherName, image,
      employeeCode, employeePosition, branch, positionId, telephone, email);
