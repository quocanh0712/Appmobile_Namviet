...
class ListStuNoCheckinView extends BaseAppBarView<ListStuNoCheckinController> {
  ListStuNoCheckinView({Key? key}) : super(key: key);
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    infoView(context, Assets.images.icDot, '10 tiết điểm danh'),
                    const SizedBox(height: 5),
                    infoView(context, Assets.images.icClock, '3 tiết vắng mặt'),
                    const SizedBox(height: 5),
                  ],
                ),
              )),
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 5),
                    infoView(context, Assets.images.icDot, '9 tiết điểm danh'),
                    const SizedBox(height: 5),
                    infoView(context, Assets.images.icClock, '1 tiết vắng mặt'),
                    const SizedBox(height: 5),
                  ],
                ),
              )),
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 5),
                    infoView(context, Assets.images.icDot, '8 tiết điểm danh'),
                    const SizedBox(height: 5),
                    infoView(context, Assets.images.icClock, '2 tiết vắng mặt'),
                    const SizedBox(height: 5),
                  ],
                ),
              )),
