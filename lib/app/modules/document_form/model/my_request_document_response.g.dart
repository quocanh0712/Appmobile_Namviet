...
_$_MyRequestDocumentResponse _$$_MyRequestDocumentResponseFromJson(
...
Map<String, dynamic> _$$_MyRequestDocumentResponseToJson(
        _$_MyRequestDocumentResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
