...
import '../controllers/request_checkin_controller.dart';

class RequestCheckInView extends StatefulHookWidget {
  final String? ScheduleCode;
  const RequestCheckInView({super.key, required this.ScheduleCode});

  @override
  State<RequestCheckInView> createState() => RequestCheckInViewState();
}

class RequestCheckInViewState extends State<RequestCheckInView> {
  final RequestCheckInController controller =
      Get.put(RequestCheckInController(), permanent: false);
  ...
  void _onQRViewCreated(QRViewController qrController) {
    ...
    qrController.scannedDataStream.listen((scanData) {
      ...
      controller.pauseQRScannerCamera();
      controller.checkin(widget.ScheduleCode, controller.result?.code);
    });
    controller.resumeQRScannerCamera();
  }
