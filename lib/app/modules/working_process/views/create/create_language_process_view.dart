...
import 'package:ftu_lms/app/modules/working_process/controllers/create/create_language_process_controller.dart';
import 'package:ftu_lms/generated/assets.gen.dart';
import 'package:ftu_lms/generated/locales.g.dart';
import 'package:ftu_lms/styles/theme_extensions.dart';
import 'package:get/get.dart';

class CreateLanguageProcessView extends BaseAppBarView<CreateLanguageProcessController> {
  CreateLanguageProcessView({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  _buildTextInputField(
                    ...
                    controller: controller.foreignController,
                  ),
                  const SizedBox(
                    height: 10,
                  ),
  ...
  String? get titleAppBar => controller.isCreated
      ...
      : LocaleKeys.editLanguageProcess.tr;
}
