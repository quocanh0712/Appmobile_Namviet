...
import '../../controllers/create/create_working_process_controller.dart';

class CreateWorkingProcessView extends BaseAppBarView<CreateWorkingProcessController> {
  CreateWorkingProcessView({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  _buildTextInputField(
                    context,
                    title: LocaleKeys.workingPosition.tr,
                  ...
                  _buildTextInputField(
                    context,
                    title: LocaleKeys.placeWorking.tr,
  ...
  String? get titleAppBar => controller.isCreated
      ? LocaleKeys.createNewWorkingProcess.tr
      : LocaleKeys.editWorkingProcess.tr;
}
