...
FinanceTeacherResponse? jsonToNullableFinanceTeacherResponse(
    Object? json) =>
...
List<FinanceTeacherResponse?> jsonToListNullableFinanceTeacherResponse(
    ...
    List<Object>.from(json as List)
        .map((e) =>
        FinanceTeacherResponse.fromJson(e as Map<String, dynamic>))
        .toList();

List<FinanceTeacherResponse> jsonToListFinanceTeacherResponse(
    Object? json) =>
    List<Object>.from(json as List)
        .map((e) =>
        FinanceTeacherResponse.fromJson(e as Map<String, dynamic>))
