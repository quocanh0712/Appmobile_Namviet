...
class EditAssignDocumenView
    extends BaseAppBarView<EditAssignDocumentController> {
  EditAssignDocumenView({Key? key}) : super(key: key);

  @override
  Widget child(BuildContext context) {
    List<Widget> listWidget = List.empty(growable: true);
    controller.editAssignDocumentResponse.listForm
