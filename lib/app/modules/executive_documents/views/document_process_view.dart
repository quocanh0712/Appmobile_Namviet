...
abstract class DocumentProcessView<T extends BaseListController>
    extends BaseListView<T> {
  DocumentProcessView({Key? key}) : super(key: key);
  ...
  String header4() => Constants.EMPTY;
  ...
  String? content4(int index) => Constants.EMPTY;
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    content4(index) ?? Constants.EMPTY,
                    textAlign: TextAlign.start,
                    style: Get.context?.themeExtensions.paragraph.copyWith(
                        color: Get.context?.themeExtensions.textColor),
                  ),
