...
class _$_CertificateResponse implements _CertificateResponse {
  ...
  @override
  String toString() {
    return 'CertificateResponse(id: $id, certificateName: $certificateName, graduationYear: $graduationYear, degree: $degree, academicRank: $academicRank, studyPlace: $studyPlace, fileName: $fileName, status: $status)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, certificateName,
      graduationYear, degree, academicRank, studyPlace, fileName, status);
