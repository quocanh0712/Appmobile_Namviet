...
class ClassSurveyResultView extends BaseListView<ClassSurveyResultController> {
  ClassSurveyResultView({Key? key}) : super(key: key);
  ...
  @override
  String? get titleAppBar => LocaleKeys.classSurveyResults.tr;
}
