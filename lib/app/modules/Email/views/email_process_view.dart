...
abstract class EmailProcessView<T extends BaseListController>
    extends BaseListView<T> {
  EmailProcessView({Key? key}) : super(key: key);
          ...
          endActionPane: ActionPane(
            ...
            children: [
              Expanded(
                ...
                child: Assets.images.icons8Forward24Svg.svg(
                    width: 24,
                    height: 24,
              ...
              Expanded(
                  child: InkWell(
                onTap: () => onActionEdit(index),
                child: Assets.images.icons8Reply24Svg.svg(
                    width: 24,
                    height: 24,
                    color: context.themeExtensions.textColor),
              )),
