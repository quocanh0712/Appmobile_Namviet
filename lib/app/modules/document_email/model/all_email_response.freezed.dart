...
AllEmailResponse _$AllEmailResponseFromJson(Map<String, dynamic> json) {
  return _AllEmailResponse.fromJson(json);
}

/// @nodoc
mixin _$AllEmailResponse {
  ...
  @JsonKey(ignore: true)
  $AllEmailResponseCopyWith<AllEmailResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllEmailResponseCopyWith<$Res> {
  factory $AllEmailResponseCopyWith(
          AllEmailResponse value, $Res Function(AllEmailResponse) then) =
      _$AllEmailResponseCopyWithImpl<$Res, AllEmailResponse>;
  @useResult
  $Res call(
      {int? id,
      String? noiDung,
...
/// @nodoc
class _$AllEmailResponseCopyWithImpl<$Res, $Val extends AllEmailResponse>
    implements $AllEmailResponseCopyWith<$Res> {
  _$AllEmailResponseCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      tieuDe: freezed == tieuDe
          ...
          : tieuDe // ignore: cast_nullable_to_non_nullable
              as String?,
      idTrangThai: freezed == idTrangThai
          ? _value.idTrangThai
...
/// @nodoc
abstract class _$$AllEmailResponseImplCopyWith<$Res>
    implements $AllEmailResponseCopyWith<$Res> {
  factory _$$AllEmailResponseImplCopyWith(_$AllEmailResponseImpl value,
          $Res Function(_$AllEmailResponseImpl) then) =
      __$$AllEmailResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$AllEmailResponseImplCopyWithImpl<$Res>
    extends _$AllEmailResponseCopyWithImpl<$Res, _$AllEmailResponseImpl>
    implements _$$AllEmailResponseImplCopyWith<$Res> {
  __$$AllEmailResponseImplCopyWithImpl(_$AllEmailResponseImpl _value,
      $Res Function(_$AllEmailResponseImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$AllEmailResponseImpl implements _AllEmailResponse {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AllEmailResponseImpl &&
  ...
  _$$AllEmailResponseImplCopyWith<_$AllEmailResponseImpl> get copyWith =>
      __$$AllEmailResponseImplCopyWithImpl<_$AllEmailResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllEmailResponseImplToJson(
      this,
    );
  }
}

abstract class _AllEmailResponse implements AllEmailResponse {
  factory _AllEmailResponse(
      {final int? id,
      final String? noiDung,
      final String? tieuDe,
      final int? idTrangThai,
