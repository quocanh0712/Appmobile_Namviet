...
class EditReportTaskView extends BaseAppBarView<EditReportTaskController> {
  EditReportTaskView({Key? key}) : super(key: key);

  @override
  Widget child(BuildContext context) {
    List<Widget> listWidget = List.empty(growable: true);
    controller.editReportTaskResponseResponse.listForm
