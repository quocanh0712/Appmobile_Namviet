...
mixin _$HomeResponseObject {
  ...
  List<HomeBannerUrl>? get homeBannerUrls => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $HomeResponseObjectCopyWith<HomeResponseObject> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HomeResponseObjectCopyWith<$Res> {
  factory $HomeResponseObjectCopyWith(
          HomeResponseObject value, $Res Function(HomeResponseObject) then) =
...
/// @nodoc
class _$HomeResponseObjectCopyWithImpl<$Res, $Val extends HomeResponseObject>
    implements $HomeResponseObjectCopyWith<$Res> {
  _$HomeResponseObjectCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      homeRecentTasks: freezed == homeRecentTasks
          ? _value.homeRecentTasks
          : homeRecentTasks // ignore: cast_nullable_to_non_nullable
              as List<HomeRecentTask>?,
      homeRecentActitvities: freezed == homeRecentActitvities
          ? _value.homeRecentActitvities
          : homeRecentActitvities // ignore: cast_nullable_to_non_nullable
              as List<HomeRecentActitvity>?,
      homeBannerUrls: freezed == homeBannerUrls
          ? _value.homeBannerUrls
          : homeBannerUrls // ignore: cast_nullable_to_non_nullable
              as List<HomeBannerUrl>?,
    ) as $Val);
  }
}
...
class _$_HomeResponseObject implements _HomeResponseObject {
  ...
  final List<HomeRecentActitvity>? _homeRecentActitvities;
  @override
  @JsonKey(name: 'listrecentlyactitvity')
  List<HomeRecentActitvity>? get homeRecentActitvities {
  ...
  final List<HomeBannerUrl>? _homeBannerUrls;
  @override
  @JsonKey(name: 'listurlbanner')
  ...
  @override
  String toString() {
    return 'HomeResponseObject(homeRecentTasks: $homeRecentTasks, homeRecentActitvities: $homeRecentActitvities, homeBannerUrls: $homeBannerUrls)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._homeBannerUrls, _homeBannerUrls));
  }
