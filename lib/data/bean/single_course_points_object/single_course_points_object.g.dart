...
_$_SingleCoursePointsObject _$$_SingleCoursePointsObjectFromJson(
...
Map<String, dynamic> _$$_SingleCoursePointsObjectToJson(
        _$_SingleCoursePointsObject instance) =>
    <String, dynamic>{
      'id': instance.id,
