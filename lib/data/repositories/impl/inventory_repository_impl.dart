...
class InventoryRepositoryImpl extends InventoryRepository {
  @override
  Future<Result<BaseResponseObject<String?>, NetworkError>> checkin(String? barcode) {
    return NetworkExecutor.execute<BaseResponseObject<String?>, BaseResponseObject<String?>>(
        route: AssetsClient.checkin(barcode), responseType: const BaseResponseObject<String?>());
  }
}
